...
const THEMES = {
    vrcn:       { label: 'VRCN', dot: '#8E8EA7', c: { 'bg-base': '#0A0A0A', 'bg-side': '#101010', 'bg-taskbar': '#101010', 'bg-card': '#0F0F0F', 'bg-hover': '#1C1C1F', 'bg-input': '#121212', 'tab-card-bg': '#0D0D0D', 'ui-input-bg': '#161618', 'ui-input-hover-bg': '#1C1C1F', 'ui-input-active-bg': '#1F2024', 'badge-bg': '#2B2C30', 'accent': '#8E8EA7', 'accent-lt': '#A5A5AC', 'cyan': '#8CA5FF', 'ok': '#2DD48C', 'warn': '#FFBA37', 'err': '#FF4B55', 'tx0': '#FFFFFF', 'tx1': '#C4C4D1', 'tx2': '#C4C4D1', 'tx3': '#8A8A9B', 'brd': '#1C1C1F', 'brd-lt': '#1C1C1F', 'bdg-user-pc': '#989DAF', 'bdg-user-quest': '#989DAF', 'bdg-user-web': '#989DAF', 'bdg-user-friend': '#2DD48C', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
