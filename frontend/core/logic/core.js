...
const THEMES = {
    vrcn:       { label: 'VRCN', dot: '#8E8EA7', c: { 'bg-base': '#0A0A0A', 'bg-side': '#0A0A0A', 'bg-taskbar': '#0A0A0A', 'bg-card': '#0F0F0F', 'bg-hover': '#1C1C1F', 'bg-input': '#121212', 'tab-card-bg': '#0D0D0D', 'ui-input-bg': '#161618', 'ui-input-hover-bg': '#1C1C1F', 'ui-input-active-bg': '#1F2024', 'badge-bg': '#2B2C30', 'accent': '#8E8EA7', 'accent-lt': '#A5A5AC', 'cyan': '#8CA5FF', 'ok': '#2DD48C', 'warn': '#FFBA37', 'err': '#FF4B55', 'tx0': '#FFFFFF', 'tx1': '#A8A8B8', 'tx2': '#9B9CAA', 'tx3': '#60606F', 'brd': '#1C1C1F', 'brd-lt': '#1C1C1F', 'bdg-user-pc': '#989DAF', 'bdg-user-quest': '#989DAF', 'bdg-user-web': '#989DAF', 'bdg-user-friend': '#2DD48C', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
    ...
    redruby:    { label: 'Red Ruby', dot: '#D04F4F', c: { 'bg-base': '#0B0B0C', 'bg-side': '#101012', 'bg-taskbar': '#101012', 'bg-card': '#151517', 'bg-hover': '#232326', 'bg-input': '#111113', 'tab-card-bg': '#131315', 'ui-input-bg': '#1C1C1F', 'ui-input-hover-bg': '#262629', 'ui-input-active-bg': '#B83C3C', 'badge-bg': '#24282E', 'accent': '#D04F4F', 'accent-lt': '#E67878', 'cyan': '#D9A58F', 'ok': '#46C88C', 'warn': '#E0A43C', 'err': '#E05555', 'tx0': '#F4EEEE', 'tx1': '#E4DADA', 'tx2': '#AB9D9D', 'tx3': '#7C7070', 'brd': '#232326', 'brd-lt': '#303034', 'bdg-user-pc': '#D98F8F', 'bdg-user-quest': '#D98F8F', 'bdg-user-web': '#D98F8F', 'bdg-user-friend': '#D98F8F', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
    mates:      { label: 'Mates', dot: '#4F50D0', c: { 'bg-base': '#0B0B0C', 'bg-side': '#101012', 'bg-taskbar': '#101012', 'bg-card': '#151517', 'bg-hover': '#232326', 'bg-input': '#111113', 'tab-card-bg': '#131315', 'ui-input-bg': '#1C1C1F', 'ui-input-hover-bg': '#262629', 'ui-input-active-bg': '#595AD6', 'badge-bg': '#24252E', 'accent': '#4F50D0', 'accent-lt': '#7E78E6', 'cyan': '#9E8FD9', 'ok': '#46C88C', 'warn': '#E0A43C', 'err': '#E05555', 'tx0': '#EEEFF4', 'tx1': '#DADCE4', 'tx2': '#9D9EAB', 'tx3': '#70727C', 'brd': '#232326', 'brd-lt': '#303034', 'bdg-user-pc': '#8F99D9', 'bdg-user-quest': '#8F99D9', 'bdg-user-web': '#8F99D9', 'bdg-user-friend': '#8F99D9', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
};
