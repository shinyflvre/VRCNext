...
const THEMES = {
    ...
    copper:     { label: 'Copper',    dot: '#D08A4F', c: { 'bg-base': '#0B0B0C', 'bg-side': '#101012', 'bg-taskbar': '#101012', 'bg-card': '#151517', 'bg-hover': '#232326', 'bg-input': '#111113', 'tab-card-bg': '#131315', 'ui-input-bg': '#1C1C1F', 'ui-input-hover-bg': '#262629', 'ui-input-active-bg': '#B8703C', 'badge-bg': '#24282E', 'badge-tx': '#ABA49D', 'accent': '#D08A4F', 'accent-lt': '#E6AC78', 'cyan': '#8FB4D9', 'ok': '#46C88C', 'warn': '#E0A43C', 'err': '#E05555', 'tx0': '#F4F1EE', 'tx1': '#E4DFDA', 'tx2': '#ABA49D', 'tx3': '#7C7670', 'brd': '#232326', 'brd-lt': '#303034', 'bdg-user-pc': '#8FB4D9', 'bdg-user-quest': '#46C88C', 'bdg-user-web': '#E0A43C', 'bdg-user-friend': '#46C88C', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
    ...
    redruby:    { label: 'Red Ruby', dot: '#D04F4F', c: { 'bg-base': '#0B0B0C', 'bg-side': '#101012', 'bg-taskbar': '#101012', 'bg-card': '#151517', 'bg-hover': '#232326', 'bg-input': '#111113', 'tab-card-bg': '#131315', 'ui-input-bg': '#1C1C1F', 'ui-input-hover-bg': '#262629', 'ui-input-active-bg': '#B83C3C', 'badge-bg': '#24282E', 'badge-tx': '#AB9D9D', 'accent': '#D04F4F', 'accent-lt': '#E67878', 'cyan': '#D9A58F', 'ok': '#46C88C', 'warn': '#E0A43C', 'err': '#E05555', 'tx0': '#F4EEEE', 'tx1': '#E4DADA', 'tx2': '#AB9D9D', 'tx3': '#7C7070', 'brd': '#232326', 'brd-lt': '#303034', 'bdg-user-pc': '#D98F8F', 'bdg-user-quest': '#D98F8F', 'bdg-user-web': '#D98F8F', 'bdg-user-friend': '#D98F8F', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
    mates:      { label: 'Mates', dot: '#4F50D0', c: { 'bg-base': '#0B0B0C', 'bg-side': '#101012', 'bg-taskbar': '#101012', 'bg-card': '#151517', 'bg-hover': '#232326', 'bg-input': '#111113', 'tab-card-bg': '#131315', 'ui-input-bg': '#1C1C1F', 'ui-input-hover-bg': '#262629', 'ui-input-active-bg': '#595AD6', 'badge-bg': '#24252E', 'badge-tx': '#9D9EAB', 'accent': '#4F50D0', 'accent-lt': '#7E78E6', 'cyan': '#9E8FD9', 'ok': '#46C88C', 'warn': '#E0A43C', 'err': '#E05555', 'tx0': '#EEEFF4', 'tx1': '#DADCE4', 'tx2': '#9D9EAB', 'tx3': '#70727C', 'brd': '#232326', 'brd-lt': '#303034', 'bdg-user-pc': '#8F99D9', 'bdg-user-quest': '#8F99D9', 'bdg-user-web': '#8F99D9', 'bdg-user-friend': '#8F99D9', 'bdg-rank-visitor': '#CCCCCC', 'bdg-rank-new': '#1778FF', 'bdg-rank-user': '#2BCF5C', 'bdg-rank-known': '#FF7B42', 'bdg-rank-trusted': '#8143E6' } },
};
...
const _TE_GROUPS = [
    ...
    { title: 'Buttons', vars: [
        ['ui-input-bg', 'Buttons Base'], ['ui-input-hover-bg', 'Buttons Hover'], ['ui-input-active-bg', 'Buttons Active'], ['badge-bg', 'Badge Base'], ['badge-tx', 'Badge Text'],
...
function addCustomThemeFromAuto() {
    const style = getComputedStyle(document.documentElement);
    const colorKeys = ['bg-base','bg-side','bg-taskbar','bg-card','bg-hover','bg-input','ui-input-bg','ui-input-hover-bg','ui-input-active-bg','badge-bg','badge-tx','accent','accent-lt','cyan','ok','warn','err','tx0','tx1','tx2','tx3','brd','brd-lt'];
    const c = {};
...
function renderCustomThemesList() {
    ...
    el.innerHTML = _customThemes.map(th => {
        ...
        return `<div class="sf-toggle-row" style="background:var(--bg-input);border-radius:8px;padding:10px 14px;">
            <div>
                <div style="font-size:calc(13px + var(--fs-off, 0px));font-weight:600;color:var(--tx0);">${esc(th.name)}</div>
                ${meta ? `<div style="font-size:calc(10px + var(--fs-off, 0px));color:var(--tx2);margin-top:2px;">${meta}</div>` : ''}
            </div>
...
function showLoadingOverlay(text) {
    ...
    if (!el) {
        ...
        el.innerHTML = '<div style="padding:18px 26px;background:var(--bg-input);border-radius:12px;color:var(--tx2);display:flex;align-items:center;gap:10px;"><span class="msi" style="font-size:20px;">sync</span><span id="vrcnLoadingOverlayText"></span></div>';
    ...
    function buildPanel() {
        ...
        for (let i = 0; i < el.options.length; i++) {
            ...
            if (count) {
                ...
                countEl.style.cssText = 'font-size:calc(10px + var(--fs-off, 0px));color:var(--tx2);flex-shrink:0;margin-left:auto;';
