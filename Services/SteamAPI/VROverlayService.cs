...
namespace VRCNext.Services
{
    public class VROverlayService : IDisposable
    {
        ...
        public readonly struct OverlayTheme
        {
            ...
            {
                ["vrcn"]          = new() { BgCard=H("#0F0F0F"),BgHover=H("#1C1C1F"),Accent=H("#8E8EA7"),Ok=H("#2DD48C"),Warn=H("#FFBA37"),Err=H("#FF4B55"),Cyan=H("#8CA5FF"),Tx1=H("#C4C4D1"),Tx2=H("#C4C4D1"),Tx3=H("#8A8A9B"),Brd=H("#1C1C1F") },
